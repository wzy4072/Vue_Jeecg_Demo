                ...
                "list": [{
                    ...
                    "list": [{
                        ...
                        "list": [
                            {
                                type: 'AsyncSelect',
                                name: 'earningOwnerList[' + 1 + '].earningOwnerType',
                                label: '受益所有人性质',
                                config: false,
                                disabled: true, // 是否禁用
                                allowClear: true,
                            ...
                            {
                                type: 'input',
                                name: 'earningOwnerList[' + 1 + '].earningOwnerTypeName',
                                label: '受益所有人性质',
                                config: false,
                            ...
                            {
                                type: 'input',
                                name: 'earningOwnerList[' + 1 + '].earningOwnerIdNo',
                                label: '受益所有人证件号码',
                                config: false,
...

                            {
                                ...
                                dateFormat: 'YYYY-MM-DD', // 日期独有 显示的格式 
                                dateValueFormat: 'YYYY-MM-DD', // 日期独有 取值赋值的格式
                                name: 'earningOwnerList[' + 1 + '].earningOwnerLimitDate',
                                label: '受益所有人证件有效期',
                                config: false,
                    ...
                    },
                    {
                        ...
                        "list": [
                            {
                                type: 'input',
                                name: 'earningOwnerList[' + 1 + '].earningOwnerName',
                                label: '受益所有人姓名',
                                config: false,
                            ...
                            {
                                type: 'input',
                                name: 'earningOwnerList[' + 1 + '].earningOwnerCountry',
                                label: '受益所有人国籍',
                                config: false,
                            ...
                            {
                                type: 'input',
                                name: 'earningOwnerList[' + 1 + '].earningOwnerAddress',
                                label: '受益所有人地址',
                                config: false,
